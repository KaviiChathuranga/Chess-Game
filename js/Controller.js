 ...
 */alert("Do want to play It ? ");

$("#black-pawn-1").on("click",btnTest_Click);
...
$("#theme").hover(function () {
    $("#theme-div").css("backgroundColor","black");
    $("#theme-div").css("opacity","0.9");
    $("#theme-div").css("filter","alpha","30");
    $(".theme-img").css("opacity","1.9");
});

$("#new-game").hover(function () {
    $("#theme-div").css("opacity","0.0");
    $("#theme-div").css("filter","alpha","0");
});
...
$("#king-wal").click(function () {
    $(".div-black").css("background-color","blue");
    $("body").css("background-image","url(img/chess-king-wallpaper-2.jpg)");
    console.log("ok");
});

$("#king-black").click(function () {
    $(".div-black").css("background-color","#0f0f0f");
    $("body").css("background-image","url(img/chess-king-hd-wallpaper-hq-pictures.jpg)");
    console.log("ok");
});
$("#king-brown").click(function () {
    $(".div-black").css("background-color","red");
    $("body").css("background-image","url(img/chess-wallpaper-background-2168-2278-hd-wallpapers.jpg)");
    console.log("ok");
});
$("#king-gray").click(function () {
    $(".div-black").css("background-color","gray");
    $("body").css("background-image","url(img/chess-king-wallpaper-23.jpg)");
    console.log("ok");
});
$("body").hover(function () {
        $("#mid-div").css("-webkit-transform", "rotateY(360deg)");
        $("#mid-div").css("transform", "rotateY(360deg)");
});
$(document).click(function () {
    var x1=event.pageX;
    var y1=event.pageY;
    var clickedElement = document.elementFromPoint(x1, y1);
    var id = null;
    id=$(clickedElement).attr('id');
    var black_pawn=null;
    for(var i=0;i<=8;i++){
        black_pawn="black-pawn-"+i;
        if(id==black_pawn){

            console.log(x1+" "+y1);
        }
    }
    var black = "chess-img-black";
    var  white="chess-img";
...
function a() {
    console.log("ds");
    $("mid-div").css("transform","rotateX(45deg)");
    //$("xmid-div").css("transform","rotateX(45deg)");
}
